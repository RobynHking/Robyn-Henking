...
export var wallSound = new soundFile("stutbeep.wav"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("keyboard.wav");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("chime.aiff");
...
export var adventureMusic = new soundFile("compt.wav");
